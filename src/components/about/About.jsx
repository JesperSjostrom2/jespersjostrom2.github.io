...
const About = () => {
  ...
  return (
    ...
    <div className="introimg">
        ...
        <p data-aos="fade-up" data-aos-delay="400">I'm a passionate <span>Frontend Developer</span> with a keen interest in web design and user experience. I love creating visually appealing and user-friendly websites that provide a seamless browsing experience.
